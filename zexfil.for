...
C     effectively this is useless, file will be trimmed to position     ***
C     of last record written                                            ***
...
58004 DO 58001 IN=1,IS                                                  EXF00226
      ...
      IF(IOP.LT.13) READ(MPOINT,END=51111) DATA(JA)                     EXF00230
C*-*-                                                                   EXF00231
C*-*- CALL FOR A POSIBLE NON-COMPATIBLE ROUTINE -IFEOF(LOCS)-           EXF00232
C*-*-     ----CHECK IT----       ----CHECK IT----                       EXF00233
C*-*-                                                                   EXF00234
C     IF(IFEOF(MPOINT).EQ.-1) GOTO 51111                                EXF00235
